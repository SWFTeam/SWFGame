    ...
    private fun getAllEvents(){
        ...
        retIn.getAllEvents(this.token).enqueue(object : Callback<Array<Event>> {
            ...
            private fun onClickEvent(view: View, event: Event){
                ...
                intent.putExtra("id", event.getDescriptions()?.get(0)?.get(0)?.getId().toString())
                intent.putExtra("country_code", event.getDescriptions()?.get(0)?.get(0)?.getCountryCode().toString())
                intent.putExtra("title", event.getDescriptions()?.get(0)?.get(0)?.getTitle().toString())
                intent.putExtra("name", event.getDescriptions()?.get(0)?.get(0)?.getName().toString())
                intent.putExtra("description", event.getDescriptions()?.get(0)?.get(0)?.getDescription().toString())
                intent.putExtra("type", event.getDescriptions()?.get(0)?.get(0)?.getType().toString())
                intent.putExtra("foreign_id", event.getDescriptions()?.get(0)?.get(0)?.getForeignId().toString())
